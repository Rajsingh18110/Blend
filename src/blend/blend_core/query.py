...
from blend.blend_core.sources import categories, engines, engine_shortcuts
from blend.blend_core.external_bang import get_bang_definition_and_autocomplete
from blend.blend_core.pipeline.models import SourceRef
...
class BangParser(QueryPartParser):
    ...
    def _parse(self, value):
        ...
        if value in engines:
            self.raw_text_query.enginerefs.append(SourceRef(value, 'none'))
            return True
