...
"""Implementations of the framework for the Markanm engines.

- :py:obj:`blend_core.enginelib.EngineCache`
- :py:obj:`blend_core.enginelib.Engine`
- :py:obj:`blend_core.enginelib.traits`
...
.. hint::
   ...
   - move implementations of the :ref:`blend_core.sources loader` to a new module in
     the :py:obj:`blend_core.enginelib` namespace.
...
if t.TYPE_CHECKING:
    from blend.blend_core.enginelib import traits
    ...
    from blend.blend_core.pipeline.processors import OfflineParamTypes, OnlineParamTypes
...
"""Global :py:obj:`blend_core.cache.ExpireCacheSQLite` instance where the cached
...
class EngineCache:
    ...
    <blend_core.cache.ExpireCacheCfg.MAXHOLD_TIME>`).  This class is a wrapper around
    :py:obj:`ENGINES_CACHE` (:py:obj:`ExpireCacheSQLite
    <blend_core.cache.ExpireCacheSQLite>`).

    In the :origin:`blend_core/sources/demo_offline.py` engine you can find an
    exemplary implementation of such a cache other examples are implemented
    in:

    - :origin:`blend_core/sources/radio_browser.py`
    - :origin:`blend_core/sources/soundcloud.py`
    - :origin:`blend_core/sources/startpage.py`

    .. code: python

       from blend.blend_core.enginelib import EngineCache
       CACHE: EngineCache
...
class Engine(abc.ABC):  # pylint: disable=too-few-public-methods
    ...
    engine_type: str
    """Type of the engine (:ref:`blend_core.pipeline.processors`)"""
    ...
    name: str
    """Name that will be used across Markanm to define this engine.  In settings, on
    the result page .."""

    engine: str
    """Name of the python file used to handle requests and responses to and from
    this search engine (file name from :origin:`blend_core/sources` without
    ``.py``)."""
    ...
    @abc.abstractmethod
    def blend_search(self, query: str, params: "OfflineParamTypes") -> "SourceResults":
