...
:py:obj:`blend_core.cache.ExpireCacheSQLite` :
  ...
  example, for the engines, see :py:obj:`blend_core.enginelib.EngineCache`.

:py:obj:`blend_core.favicons.cache.FaviconCacheSQLite` :
