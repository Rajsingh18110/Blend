# نحو جستجو
blend با یک متن جستجو همراه است که می توانید دسته ها را تغییر دهید،
...
blend از ضربه های خارجی پشتیبانی می کند [DuckDuckGo] .  To مستقیماً به a
...
موتور، blend نمی تواند از حریم خصوصی شما در این مورد محافظت کند.
