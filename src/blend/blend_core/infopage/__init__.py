...
"""Render Markanm instance documentation.
...
logger = logging.getLogger('blend.blend_core.infopage')
...
class InfoPageSet:  # pylint: disable=too-few-public-methods
    """Cached rendering of the online documentation a Markanm instance has.
