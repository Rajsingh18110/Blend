...
"""Blend preferences implementation."""
...
from blend.blend_core import settings, autocomplete, favicons
...
from blend.blend_core.locales import LOCALE_NAMES
...
class PluginsSetting(BooleanChoices):
    ...
    def __init__(self, default_value, plugins: Iterable[blend_core.extensions.Plugin]):
...
class ClientPref:
    ...
    # hint: blend_core.webapp.get_client_settings should be moved into this class
...
class Preferences:
    ...
    def __init__(
        ...
        plugins: blend_core.extensions.PluginStorage,
...
def is_locked(setting_name: str):
    """Checks if a given setting name is locked by blend_config.yml"""
