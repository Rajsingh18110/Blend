...
the ``blend_config.yml`` file is already located (``/etc/markanm``). The file then
...
from blend.blend_core.result_types._base import MainResult, LegacyResult
from blend.blend_core.settings_loader import get_yaml_cfg
from blend.blend_core.extensions import Plugin, PluginInfo
...
if t.TYPE_CHECKING:
    ...
    from blend.blend_core.result_types import Result
