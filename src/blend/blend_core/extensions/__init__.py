...
""".. sidebar:: Further reading ..
   ...
   - :ref:`plugins admin`
   - :ref:`Markanm settings <settings plugins>`

Plugins can extend or replace functionality of various components of Markanm.
...
built-in plugins :origin:`blend_core/extensions/` or `Only show green hosted results`_.

.. _Only show green hosted results:
   https://github.com/return42/tgwf-blend-plugins/
...
.. code:: python
   ...
   from blend.blend_core.extensions import Plugin
...
.. sidebar:: Further reading ..
   ...
   - :py:obj:`Result.filter_urls(..) <blend_core.result_types._base.Result.filter_urls>`

The :py:obj:`Result.filter_urls(..) <blend_core.result_types._base.Result.filter_urls>`
...
import blend.blend_core as blend_core
...
def initialize(app):
    STORAGE.load_blend_config(blend_core.get_setting("plugins"))
    STORAGE.init(app)
