...
"""Bing-News: description see :py:obj:`blend_core.sources.bing`.
...
from blend.blend_core.sources.bing import (
    get_locale_params,
...
def fetch_traits(engine_traits: EngineTraits):
    ...
    from blend.blend_core.sources.bing import fetch_traits as _f
