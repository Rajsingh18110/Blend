...
from blend.blend_core.utils import gen_useragent, ElementType
from blend.blend_core.sources.xpath import extract_url, extract_text, eval_xpath_list, eval_xpath
