...
from blend.blend_core.sources.json_engine import safe_search_map
from blend.blend_core.exceptions import BlendEngineAPIException
from blend.blend_core.network import get, raise_for_httperror
from blend.blend_core.result_types import SourceResults
from blend.blend_core.utils import extr, js_obj_str_to_python, html_to_text
...
def _get_session_id() -> str:
    ...
    if not session_id:
        raise BlendEngineAPIException("failed to obtain session id")
...
def request(query: str, params: "OnlineParams"):
    ...
    language: str = traits.get_language(
        params["markanm_locale"], default="All"
