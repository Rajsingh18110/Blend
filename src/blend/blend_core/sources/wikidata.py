...
from blend.blend_core.data import WIKIDATA_UNITS
from blend.blend_core.network import post, get
from blend.blend_core.utils import markanm_useragent, get_string_replaces_function
from blend.blend_core.external_urls import get_external_url, get_earth_coordinates_url, area_to_osm_zoom
from blend.blend_core.sources.wikipedia import (
...
def get_headers():
    ...
    return {'Accept': 'application/sparql-results+json', 'User-Agent': markanm_useragent()}
...
def request(query, params):
    ...
    eng_tag, _wiki_netloc = get_wiki_params(params['markanm_locale'], traits)
...
def fetch_traits(engine_traits: EngineTraits):
    ...
    <blend_core.sources.wikipedia.fetch_wikimedia_traits>` and removes
