...
.. hint::
   ...
   This Markanm engine only supports *'searching by URL'* and it does not use
...
""":py:obj:`blend_core.pipeline.processors.online_url_search`"""
    ...
    if resp.status_code in (400, 422):
        ...
        if resp.status_code == 422:
            ...
            if s_key == "Invalid image URL":
                # test https://docs.markanm.org/_static/markanm-wordmark.svg
        ...
        # see https://github.com/markanm/markanm/pull/1456#issuecomment-1193105023
