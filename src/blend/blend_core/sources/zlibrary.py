...
from blend.blend_core.data import ENGINE_TRAITS
from blend.blend_core.enginelib.traits import EngineTraits
from blend.blend_core.exceptions import BlendException
from blend.blend_core.result_types import SourceResults
from blend.blend_core.utils import ElementType, eval_xpath, eval_xpath_list, extract_text
...
def fetch_traits(engine_traits: EngineTraits) -> None:
    ...
    from blend.blend_core.locales import language_tag
