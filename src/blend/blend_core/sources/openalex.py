...
- Language filter support (maps Markanm language to ``filter=language:<iso2>``)
...
Minimal example for :origin:`blend_config.yml <blend/blend_config.yml>`:
...
# Optional: include your email for OpenAlex polite pool. Can be set from blend_config.yml
