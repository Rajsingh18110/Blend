...
If you want to use invidious with Markanm you should setup one locally.
No public instance offer a public API now

- https://github.com/markanm/markanm/issues/2722#issuecomment-2884993248
...
# base_url can be overwritten by a list of URLs in the blend_config.yml
