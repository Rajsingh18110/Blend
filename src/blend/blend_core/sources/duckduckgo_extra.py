...
from blend.blend_core.utils import get_embeded_stream_url, html_to_text, gen_useragent, extr
from blend.blend_core.network import get  # see https://github.com/markanm/markanm/issues/762

from blend.blend_core.sources.duckduckgo import fetch_traits  # pylint: disable=unused-import
from blend.blend_core.sources.duckduckgo import get_ddg_lang, get_vqd, set_vqd
...
def request(query: str, params: "OnlineParams") -> None:
    ...
    eng_region: str = traits.get_region(
        params["markanm_locale"],
        traits.all_locale,
    )  # pyright: ignore[reportAssignmentType]

    eng_lang: str = get_ddg_lang(traits, params["markanm_locale"]) or "wt-wt"
    ...
    if params["markanm_locale"] != "all":
        args["ct"] = params["markanm_locale"].split("-")[0].upper()
