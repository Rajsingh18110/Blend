...
authentication.  What this means is that by default, Markanm will have no way to
...
from blend.blend_core.utils import html_to_text, humanize_number
...
"""Optional, if true Markanm will link directly to the mp4 of the video to play
...
def video_response(resp, results: SourceResults) -> None:
