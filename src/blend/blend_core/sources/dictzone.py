...
from blend.blend_core.utils import eval_xpath, extract_text
from blend.blend_core.result_types import SourceResults
from blend.blend_core.network import get as http_get  # https://github.com/markanm/markanm/issues/762
