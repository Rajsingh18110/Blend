...
from blend.blend_core.utils import extract_text, extract_url, eval_xpath, eval_xpath_list
...
def response(resp) -> SourceResults:  # pylint: disable=too-many-branches
