...
from blend.blend_core.utils import eval_xpath_list, eval_xpath, extract_text
...
def request(query: str, params: "OnlineParams") -> None:
    ...
    language, region = (params["markanm_locale"].split("-") + [None])[:2]
...
def _general_results(doc: html.HtmlElement) -> SourceResults:
    res = SourceResults()
...
def _video_results(doc: html.HtmlElement) -> SourceResults:
    res = SourceResults()
...
def _image_results(doc: html.HtmlElement) -> SourceResults:
    res = SourceResults()
