...
from blend.blend_core.utils import extract_text, html_to_text, get_string_replaces_function
from blend.blend_core.external_urls import (
    get_external_url,
    ...
    if "Infobox" in search_res:
        ...
        if "content" in infobox:
            ...
            for info in infobox.get("content", {}):
                ...
                elif data_type in ["instance", "wiki_maps_trigger", "blend_play_artist_id"]:
                    # ignore instance: Wikidata value from "Instance Of" (Qxxxx)
                    # ignore wiki_maps_trigger: reference to a javascript
                    # ignore blend_play_artist_id: service shutdown
                    pass
