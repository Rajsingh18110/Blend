...
and unpack into ``blend/data/filmliste-v2.db``.  To search the database use e.g
...
.. code:: yaml
  ...
  - name: mediathekview
    ...
    database: blend/data/filmliste-v2.db
    query_str: >-
...
from blend.blend_core.result_types import MainResult, KeyValue
...
def blend_search(query, params) -> SourceResults:
    res = SourceResults()
    query_params = {
        'query': query,
