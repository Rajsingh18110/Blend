...
__all__ = ["DEFAULT_RESOLVER_MAP", "allesedv", "duckduckgo", "blend", "yandex"]
...
def _req_args(**kwargs):
    # add the request arguments from the blend_core.network
...
def blend(domain: str, timeout: int) -> tuple[None | bytes, None | str]:
    """Favicon Resolver from blend.com"""
    data, mime = (None, None)

    # URL https://www.blend.com/s2/favicons?sz=32&domain={domain}" will be
