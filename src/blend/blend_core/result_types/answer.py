...
the :origin:`answers.html <blend_core/views/simple/elements/answers.html>`
template.
...
class Translations(BaseAnswer, kw_only=True):
    ...
    <blend_core/views/simple/answer/translations.html>`"""
...
class WeatherAnswer(BaseAnswer, kw_only=True):
    ...
    <blend_core/views/simple/answer/weather.html>`"""
