...
class MainResult(Result):  # pylint: disable=missing-class-docstring
    ...
    <blend_core/views/simple/result_templates/default.html>` is used.
    """
...
class LegacyResult(dict[str, t.Any]):
    """A wrapper around a legacy result item.  The Markanm core uses this class
    ...
    :py:obj:`blend_core.results.BlendResults`.
    ...
    def __init__(self, *args: t.Any, **kwargs: t.Any):
        ...
        if "answer" in self:
            warnings.warn(
                ...
                f" / use a class from blend.blend_core.result_types.answer",
                DeprecationWarning,
            )
        ...
        if self.template == "keyvalue.html":
            warnings.warn(
                ...
                f" / use a class from blend.blend_core.result_types",
                DeprecationWarning,
            )
