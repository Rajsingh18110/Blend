...
Output file: :origin:`blend/data/osm_keys_tags` (:origin:`CI Update data ...
...
from blend_core.network import set_timeout_for_thread
from blend_core.sources import wikidata, set_loggers
from blend_core.blend_locales import blend_locales
from blend_core.sources.openstreetmap import get_key_rank, VALUE_TO_LINK
...
LANGUAGES = [l[0].lower() for l in blend_locales]
