...
"""Update locale names in :origin:`blend/data/locales.json` used by
:ref:`blend_core.locales`

- :py:obj:`blend_core.locales.RTL_LOCALES`
- :py:obj:`blend_core.locales.LOCALE_NAMES`
"""
...
LOCALE_DATA_FILE = Path(blend_dir) / 'data' / 'locales.json'
TRANSLATIONS_FOLDER = Path(blend_dir) / 'translations'
