...
"""Fetch currencies from :origin:`blend_core/sources/wikidata.py` engine.

Output file: :origin:`blend/data/currencies.json` (:origin:`CI Update data ...
...
from blend_core.locales import LOCALE_NAMES, locales_initialize
from blend_core.sources import wikidata, set_loggers
from blend_core.data.currencies import CurrenciesDB
...
def main():
    ...
    # blend_core.pipeline.processors.online_currency.name_to_iso4217
