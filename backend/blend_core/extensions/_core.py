...
if t.TYPE_CHECKING:
    ...
    from blend_core.result_types import Result, SourceResults, LegacyResult  # pyright: ignore[reportPrivateLocalImportUsage]
    import flask

log: logging.Logger = logging.getLogger("blend_core.extensions")
