...
from blend_core import network
from blend_core.cache import ExpireCache, ExpireCacheCfg
from blend_core.extended_types import blend_request
from blend_core.wikidata_units import convert_to_si, convert_from_si
...
def _get_sxng_locale_tag() -> str:
    ...
    from blend_core import query
    from blend_core.preferences import ClientPref
