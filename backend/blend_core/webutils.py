...
from blend_core import logger, get_setting
...
if TYPE_CHECKING:
    ...
    from blend_core.pipeline import BlendQuery
    from blend_core.results import UnresponsiveEngine
...
exception_classname_to_text = {
    ...
    'blend_core.exceptions.BlendEngineCaptchaException': gettext("CAPTCHA"),
    'blend_core.exceptions.BlendEngineTooManyRequestsException': gettext("too many requests"),
    'blend_core.exceptions.BlendEngineAccessDeniedException': gettext("access denied"),
    'blend_core.exceptions.BlendEngineAPIException': gettext("server API error"),
    'blend_core.exceptions.BlendEngineXPathException': parsing_error_text,
