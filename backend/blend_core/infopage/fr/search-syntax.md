...
blend permet de modifier les catégories de recherche, les moteurs
...
blend supporte les recherches [DuckDuckGo] de type "!Bang". Utilisez
...
sur le moteur externe. Dans ce cas, blend ne peut pas protéger votre
vie privée.
...
dangereux. Dans ce cas, blend ne peut pas protéger votre vie
