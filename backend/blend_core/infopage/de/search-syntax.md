...
blend verfügt über eine Syntax mit der in einer Suchanfrage die Kategorien,
...
blend unterstützt die _external bangs_ von [DuckDuckGo].  Das Präfix `!!` kann
...
blend kann die Privatsphäre des Benutzers in diesem Fall nur eingeschränkt
...
Vertrauenswürdigkeit überprüft werden.  blend kann die Privatsphäre des
