...
def get_locale_params(engine_region: str | None) -> dict[str, str] | None:
    ...
    This function is shared with :py:mod:`blend_core.sources.bing_images`,
    :py:mod:`blend_core.sources.bing_news`, and :py:mod:`blend_core.sources.bing_videos`.
    """
...
def override_accept_language(params: "OnlineParams", engine_region: str | None) -> None:
    ...
    The default header built by :py:class:`~blend_core.pipeline.processors.online.OnlineProcessor`
...
def request(query: str, params: "OnlineParams") -> "OnlineParams":
    ...
    engine_region = traits.get_region(params["markanm_locale"], traits.all_locale)
