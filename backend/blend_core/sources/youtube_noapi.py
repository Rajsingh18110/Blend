...
search_url = base_url + '?blend_query={query}&page={page}'
time_range_url = '&sp=EgII{time_range}%253D%253D'
youtubei_api_key = os.environ.get("YOUTUBEI_API_KEY", "")
next_page_url = 'https://www.youtube.com/youtubei/v1/search?key={api_key}'
...
def request(query, params):
    ...
    if not params['engine_data'].get('next_page_token'):
        ...
        params['url'] = next_page_url.format(api_key=youtubei_api_key)
        params['method'] = 'POST'
        params['data'] = dumps(
            {
