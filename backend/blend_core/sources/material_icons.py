...
about = {
    "website": 'https://fonts.blend.com/icons',
...
search_url = "https://fonts.blend.com/metadata/icons?key=material_symbols&incomplete=true"
result_url = "https://fonts.blend.com/icons?icon.query={query}&selected=Material+Symbols+Outlined:{icon_name}:FILL@0{fill};wght@400;GRAD@0;opsz@24"  # pylint: disable=line-too-long
