...
from blend_core.data import OSM_KEYS_TAGS, CURRENCIES
from blend_core.external_urls import get_external_url
from blend_core.sources.wikidata import send_wikidata_query, sparql_string_escape, get_thumbnail
