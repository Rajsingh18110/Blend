...
from blend_core import logger, settings
from blend_core.utils import load_module
...
def load_engine(engine_data: dict[str, t.Any]) -> "Engine | types.ModuleType | None":
    ...
    from blend_core.enginelib.traits import EngineTraitsMap
...
def set_loggers(engine: "Engine|types.ModuleType", engine_name: str):
    ...
    for module_name, module in modules.items():
        if (
            module_name.startswith("blend_core.sources")
            and module_name != "blend_core.sources.__init__"
