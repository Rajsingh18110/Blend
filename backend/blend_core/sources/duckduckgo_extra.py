...
from blend_core.utils import get_embeded_stream_url, html_to_text, gen_useragent, extr
from blend_core.network import get  # see https://github.com/markanm/markanm/issues/762

from blend_core.sources.duckduckgo import fetch_traits  # pylint: disable=unused-import
