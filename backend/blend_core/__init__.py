...
def init_settings():
    ...
    from blend_core import settings_loader
    from blend_core.settings_defaults import SCHEMA, apply_schema
...
from blend_core import sources as engines  # noqa: E402  pylint: disable=wrong-import-position
