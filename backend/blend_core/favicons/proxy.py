...
from blend_core.webutils import new_hmac, is_hmac_of
from blend_core.exceptions import BlendEngineResponseException
...
def _initial_resolver_map():
    ...
    if name:
        ...
        if func:
            d = {name: f"blend_core.favicons.resolvers.{func.__name__}"}
    return d
